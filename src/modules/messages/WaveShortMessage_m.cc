...
void WaveShortMessage::copy(const WaveShortMessage& other)
{
    ...
    this->ipPacketMsg_var = other.ipPacketMsg_var;
    this->arpPacketMsg_var = other.arpPacketMsg_var;
...
void WaveShortMessage::parsimPack(cCommBuffer *b)
{
    ...
    doPacking(b,this->ipPacketMsg_var);
    doPacking(b,this->arpPacketMsg_var);
...
void WaveShortMessage::parsimUnpack(cCommBuffer *b)
{
    ...
    doUnpacking(b,this->ipPacketMsg_var);
    doUnpacking(b,this->arpPacketMsg_var);
...
IPv4Datagram& WaveShortMessage::getIpPacketMsg()
{
    return ipPacketMsg_var;
}

void WaveShortMessage::setIpPacketMsg(const IPv4Datagram& ipPacketMsg)
{
    this->ipPacketMsg_var = ipPacketMsg;
}

ARPPacket& WaveShortMessage::getArpPacketMsg()
{
    return arpPacketMsg_var;
}

void WaveShortMessage::setArpPacketMsg(const ARPPacket& arpPacketMsg)
{
    this->arpPacketMsg_var = arpPacketMsg;
}
...
int WaveShortMessageDescriptor::findField(void *object, const char *fieldName) const
{
    ...
    if (fieldName[0]=='i' && strcmp(fieldName, "ipPacketMsg")==0) return base+9;
    if (fieldName[0]=='a' && strcmp(fieldName, "arpPacketMsg")==0) return base+10;
    if (fieldName[0]=='s' && strcmp(fieldName, "senderAddress")==0) return base+11;
    if (fieldName[0]=='r' && strcmp(fieldName, "recipientAddress")==0) return base+12;
    if (fieldName[0]=='s' && strcmp(fieldName, "serial")==0) return base+13;
...
std::string WaveShortMessageDescriptor::getFieldAsString(void *object, int field, int i) const
{
    ...
    switch (field) {
        ...
        case 9: {std::stringstream out; out << pp->getIpPacketMsg(); return out.str();}
        case 10: {std::stringstream out; out << pp->getArpPacketMsg(); return out.str();}
        case 11: return long2string(pp->getSenderAddress());
        case 12: return long2string(pp->getRecipientAddress());
        case 13: return long2string(pp->getSerial());
...
bool WaveShortMessageDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    ...
    switch (field) {
        ...
        case 11: pp->setSenderAddress(string2long(value)); return true;
        case 12: pp->setRecipientAddress(string2long(value)); return true;
        case 13: pp->setSerial(string2long(value)); return true;
...
const char *WaveShortMessageDescriptor::getFieldStructName(void *object, int field) const
{
    ...
    switch (field) {
        case 9: return opp_typename(typeid(IPv4Datagram));
        case 10: return opp_typename(typeid(ARPPacket));
...
void *WaveShortMessageDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    ...
    WaveShortMessage *pp = (WaveShortMessage *)object; (void)pp;
    switch (field) {
        case 9: return (void *)(&pp->getIpPacketMsg()); break;
        case 10: return (void *)(&pp->getArpPacketMsg()); break;
