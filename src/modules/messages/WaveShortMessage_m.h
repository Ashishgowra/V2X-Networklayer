...
/**
 * Class generated from <tt>modules/messages/WaveShortMessage.msg:32</tt> by nedtool.
 * <pre>
...
class WaveShortMessage : public ::cPacket
{
  protected:
    ...
    IPv4Datagram ipPacketMsg_var;
    ARPPacket arpPacketMsg_var;
  ...
  public:
    ...
    virtual IPv4Datagram& getIpPacketMsg();
    virtual const IPv4Datagram& getIpPacketMsg() const {return const_cast<WaveShortMessage*>(this)->getIpPacketMsg();}
    virtual void setIpPacketMsg(const IPv4Datagram& ipPacketMsg);
    virtual ARPPacket& getArpPacketMsg();
    virtual const ARPPacket& getArpPacketMsg() const {return const_cast<WaveShortMessage*>(this)->getArpPacketMsg();}
    virtual void setArpPacketMsg(const ARPPacket& arpPacketMsg);
