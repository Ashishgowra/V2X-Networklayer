...
class Mac1609_4 : public BaseMacLayer,
	...
	protected:
		/** @brief Added by Parag  */
		 ...
		 /** @brief Added by Parag  */
		 WaveShortMessage* piggybackIPOverWSM(IPv4Datagram*);

		 /** @brief Added by Parag  */
		 WaveShortMessage* piggybackARPOverWSM(ARPPacket*);
		...
		virtual void sendIpUp(cMessage *msg);

		virtual void sendWsmUp(cMessage *msg);
